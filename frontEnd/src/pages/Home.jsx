    ...
    <Container>
      <div className="flex my-9 mx-auto flex-col justify-center items-center gap-2 max-w-[500px]">
        <div className="text-center mb-12">
          ...
          <p>A sua plataforma de gerenciamento das suas colmeias.</p>
        </div>
        <div className="flex flex-col gap-2 w-full mb-5 px-8">
          <Button
            className="bg-yellow-500 w-full py-2 px-5 rounded-md text-brown-500 cursor-pointer font-semibold hover:bg-yellow-600"
            onClick={() => goTo("/login")}
          >
            Já tenho conta
          </Button>
          <Button onClick={() => goTo("/criar_conta")}>
            Quero me cadastrar
          </Button>
        </div>
